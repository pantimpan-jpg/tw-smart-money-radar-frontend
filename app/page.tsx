  ...
  return (
    <main className="mx-auto max-w-7xl space-y-6 px-4 py-6">
      <section className="rounded-[28px] bg-slate-900 px-6 py-7 text-white shadow-sm md:px-8 md:py-8">
        <h1 className="text-3xl font-bold tracking-tight md:text-4xl">全市場股票搜尋</h1>
        <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-300 md:text-base">
          搜尋任意股票，直接進入和榜單股票相同的個股頁。若該股未進今日榜單，仍可查看 EPS、營收、股利、財報、新聞、法人與融資融券資料。
        </p>
      ...
      {q ? (
        ...
        <section className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-100">
          <div className="text-slate-600">請先輸入股號、股名或題材關鍵字開始搜尋。</div>
        </section>
      )}
    </main>
  )
